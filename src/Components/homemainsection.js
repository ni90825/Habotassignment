...
<div className='w-full h-full absolute flex flex-col gap-12 sm:gap-16 justify-center items-center'>
  <div className="font-Poppins text-4xl md:text-5xl xl:text-[57px] leading-[75px] w-[98%] xl:w-4/6 pt-5 sm:py-0" style={{lineHeight:1.3}} data-aos="zoom-in">
...
<div className="flex gap-3 justify-between w-[90%] lg:w-[70%] flex-col lg:flex-row" data-aos="fade-down">
...
<div className="text-lg flex gap-2 items-center sm:items-unset flex-col sm:flex-row" data-aos="fade-down">
